...
set mode_constraints($mode1)            "../SCRIPTSICC/fun.sdc" ;# for mode1 specific SDC constraints

set mode2 				"func_turbo" ;# name for mode1	
set mode_constraints($mode2)            "../SCRIPTSICC/turbo.sdc" ;# for mode2 specific SDC constraints

## Corner constraints; expand it as needed
set corner1 				"ss0p6v125c" ;# name of corner1	
set corner_constraints($corner1)        "../SCRIPTSICC/ss0p6v125c.tcl" ;# for corner1 specific SDC constraints 

set corner2 				"ff0p7vm40c" ;# name of corner2	
set corner_constraints($corner2)        "../SCRIPTSICC/ff0p7vm40c.tcl" ;# for corner2 specific SDC constraints 
...
set scenario_constraints($scenario3)    "" ;# for scenario3 specific SDC constraints
...
set_scenario_status $scenario2 -none -setup true -hold false -leakage_power true -dynamic_power true -max_transition true -max_capacitance true -min_capacitance false -active true
...
redirect -file ../reports/scenarios.report_scenarios.rpt {report_scenarios}
## Note :
