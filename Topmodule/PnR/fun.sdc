...
set_input_delay 0.5 -clock pll [remove_from_collection [all_inputs] [get_ports pll_clk]]

set_input_delay 0.5 -clock ext [remove_from_collection [all_inputs] [get_ports ext_clk]]
