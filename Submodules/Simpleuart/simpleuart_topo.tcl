...
#Global Variables
#################
set DESIGN_NAME "simpleuart"; #  The name of the design
set OUTPUTS_DIR  /home1/BPD23/VSchandrika/RM_Raven/SUBMODULE/SIMPLEUART/OUTPUT_DIR
set SCRIPTS /home1/BPD23/VSchandrika/RM_Raven/SUBMODULE/SIMPLEUART/SCRIPTS
set DESIGN_STYLE "hier" ; #hier or flat
set PHYSICAL_HIERARCHY_LEVEL "top" ; #bottom or top
set DC_BLOCK_ABSTRACTION_DESIGNS "" ;
set DDC_HIER_DESIGNS "simpleuart" ;
set UPF_MODE ""
...
#Analyze
analyze -f verilog [glob /home1/BPD23/VSchandrika/rtl/simpleuart.v]
...
set_voltage 0.6 -object_list {VDDo}
set_voltage 0.0 -object_list {VSS}
create_operating_conditions -name OP125_1_72 -process 1 -temperature 125 -voltage 0.72 -library saed14rvt_dlvl_ss0p72v125c_i0p6v 
set_operating_conditions -max OP125_1_72 -min OP125_1_72 -library  saed14rvt_dlvl_ss0p72v125c_i0p6v 
...
set compile_ultra_cmd "compile_ultra -gate_clock -scan -no_autoungroup -no_boundary_optimization"
...
report_design > ${OUTPUTS_DIR}/design.rpt
